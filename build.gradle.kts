...
kotlin {
    ...
    val xcf = XCFramework("WinapiUtil")
    ...
    swiftExport {
        moduleName = "WinapiUtil"
        flattenPackage = "io.github.kotlinmania.winapiutil"
    }

    android {
        namespace = "io.github.kotlinmania.winapiutil"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "winapi-util-kotlin", version.toString())

    pom {
        name.set("winapi-util-kotlin")
        description.set("Kotlin Multiplatform port of BurntSushi/winapi-util - A dumping ground for high level safe wrappers over windows-sys")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/winapi-util-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/winapi-util-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/winapi-util-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/winapi-util-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleWinapiUtilXCFramework",
    "assembleWinapiUtilDebugXCFramework",
    "assembleWinapiUtilReleaseXCFramework",
    "assembleDebugIosFatFrameworkForWinapiUtilXCFramework",
    "assembleReleaseIosFatFrameworkForWinapiUtilXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForWinapiUtilXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForWinapiUtilXCFramework",
    "assembleDebugMacosFatFrameworkForWinapiUtilXCFramework",
    "assembleReleaseMacosFatFrameworkForWinapiUtilXCFramework",
    "assembleDebugTvosFatFrameworkForWinapiUtilXCFramework",
    "assembleReleaseTvosFatFrameworkForWinapiUtilXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForWinapiUtilXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForWinapiUtilXCFramework",
    "assembleDebugWatchosFatFrameworkForWinapiUtilXCFramework",
    "assembleReleaseWatchosFatFrameworkForWinapiUtilXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForWinapiUtilXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForWinapiUtilXCFramework",
...
// kotlinc-compiled commonMain through the CodeQL Java agent. The Android
// Kotlin Multiplatform plugin runs kotlinc through K2's phased multiplatform
// pipeline, which bypasses K2JVMCompiler.doExecute, so this task uses a
// single-target kotlinc invocation that gives CodeQL a direct Kotlin compile.
...
dependencies {
    ...
    // No codeqlAndroidAar(...) entries: this port has no io.github.kotlinmania:*-kotlin-android
    // sibling dependencies. The configuration is wired for future Android AAR dependencies.
}
...
tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    val sources = files(commonSources)
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile =
                sentinelDir.get().asFile.resolve("io/github/kotlinmania/winapiutil/codeql/_CodeqlEmptySource.kt")
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.winapiutil.codeql
