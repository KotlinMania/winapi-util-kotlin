...
This file is the quick-reference operating contract for winapi-util-kotlin. The longer
...
winapi-util-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`winapi-util`](https://crates.io/crates/winapi-util). Upstream Rust is the behavioral oracle while the
